    ...
    return (
        <div className="sm:w-9/12 w-full grid grid-rows-auto gap-40 m-auto mt-40" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))" }}>
            <div className={SectionClasses_div}>
                <div className={SectionClasses_img}><Image src={accessIcon} alt="accessIcon" layout="fill" /></div>
            ...
            <div className={SectionClasses_div}>
                <div className={SectionClasses_img}><Image src={secureIcon} alt="secureIcon" layout="fill" /></div>
            ...
            <div className={SectionClasses_div}>
                <div className={SectionClasses_img}><Image src={collaIcon} alt="collaIcon" layout="fill" /></div>
            ...
            <div className={SectionClasses_div}>
                <div className={SectionClasses_img}><Image src={storeIcon} alt="storeIcon" layout="fill" /></div>
